...
<h2 align="center"><a href="https://github.com/joenapper/Memory-games/blob/master/README.md"><img src="README-assets/learn-more-btn.png"></a> <img src="README-assets/small-simon.png"> <a href="https://joenapper.github.io/Memory-games/"><img src="README-assets/live-website-btn.png"></a></h2>
...
- ### Design
    - #### Colour Scheme
        ...
        on mobile and tablets for easier navigation through the site. I picked these two colors as they compliment each other and in 
        my opinion radiate cleanliness and simplicity. The psychological effects that the color scheme has on the user is instant and can
        dictate whether the user will continue to browse the site or leave.
            ...
            as opposed to black, white is a reflective color which creates almost an invisible barrier to the user where they would sub-consciously  beable
            to interact with the pages better as we are less likely to click on white compared to a more contrasting color. 
            - [#1c75bc](https://www.colorhexa.com/1c75bc) (Strong Blue): The strong blue color was used for all the titles/subtitles, buttons, and shadows.
            These contrasts really well against off-white background and are eye-catching and 'stand-offish'. Strong blues stimulate clear thoughts and allow 
            for better reading.
        To conclude, the color scheme is implemented to create a clean, slick, professional look that allows for better user experience and increasing possibilities
        of that particular visitor to return.
    - #### Typography
        ...
        reason, the font Isn't being imported to the site correctly. Oswald was used for all the headers, sub-headers, and areas of key importance to
        maintain a professional look throughout and create a clear distinction from the content text. This font was imported to the 'styles.css' from Google Fonts,
        where it is very easy to import from and is also an extremely reliable external source. The font is available in 6 different weights from 'Extra-light' (200 weight) 
        to 'Bold' (700 weight). Not only that, but they also provide a 'Variable weight axis' where you can set a custom font-weight to import so you're not limited
    ...
    - #### Imagery
        ...
        them too drastically with hard code which can sometimes ruin the quality of an image. I also focussed on obtaining images that would best suit there
...
- #### First Time Visitor Goals
    ...
    1. I want to easily understand the main purpose of the site.
        1. Upon entering, you are greeted with an informative hero image which described the goal of the site and a clear, easy to read navigation bar.
        2. As the hero image only takes up 50 percent of the viewport height the user will still be able to see the game selection area which would entise them to look at.
    ...
    2. I want striking imagery to help visually represent each section.
        ...
        3. All images are fully responsive and have been altered to look good on any device size.
...
- #### Returning Visitor Goals
    ...
    2. I want to easily send suggestions for new games and/or updates that can be added.
        ...
        3. A form section is on each page and for the games, the form can be found directly below them so the user won't be led away. 
